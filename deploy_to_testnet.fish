...
alias mockup-client='tezos-client'
...
set balancer "tz1LaoaJjcH48E3kFjcwv7ySEfavcnaUYnyp" # bootstrap5

set token_storage_ligo "record [
  total_supply = 100_000_000_000n;
  ledger = big_map[
    (\"$balancer\" : address) -> record[
        balance = 4_500_000n;
...
mockup-client originate contract token_a transferring 1 from balancer \
...
mockup-client originate contract token_b transferring 1 from balancer \
                        running ./contracts/compiled/TokenFA12.tz \
                        --burn-cap 10 --force \
                        --init (echo $token_storage_mich)
...
mockup-client originate contract sapling_dex transferring 0 from balancer \
